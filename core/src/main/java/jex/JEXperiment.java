...
public class JEXperiment extends JFrame implements ActionListener, WindowListener, WindowFocusListener, KeyEventDispatcher {
	...
	public SignalMenuButton back = new SignalMenuButton();
	...
	public void createMenuBar()
	{
		...
		Image back = JEXStatics.iconRepository.getImageWithName(IconRepository.BUTTON_BACK, 30, 30);
		//Image iconOverSave = JEXStatics.iconRepository.getImageWithName(IconRepository.MAIN_SAVE, 30, 30);
		//Image iconPressedSave = JEXStatics.iconRepository.getImageWithName(IconRepository.MAIN_SAVE, 30, 30);
		this.back.setBackgroundColor(DisplayStatics.menuBackground);
		this.back.setForegroundColor(DisplayStatics.lightBackground);
		this.back.setClickedColor(DisplayStatics.menuBackground, DisplayStatics.lightBackground);
		this.back.setSize(new Dimension(100, 50));
		this.back.setImage(back);
		this.back.setMouseOverImage(back);
		this.back.setMousePressedImage(back);
		this.back.setDisabledImage(greyBox);
		this.back.setText("Back");
		SSCenter.defaultCenter().connect(this.back, SignalMenuButton.SIG_ButtonClicked_NULL, this, "backToDatabase", (Class[]) null);
		this.menuPane.add(Box.createHorizontalStrut(spacing));
		this.menuPane.add(this.back);
	...
	/**
	 * Go back to Database Choosing screen
	 */
	...
	public void backToDatabase() {
		...
		JEXStatics.main.showMainJEXWindow(false);
		String userFile = JEXStatics.jexManager.getCurrentUserFile();
