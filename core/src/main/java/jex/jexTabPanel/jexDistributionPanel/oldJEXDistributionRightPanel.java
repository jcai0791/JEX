...
public class oldJEXDistributionRightPanel extends JPanel implements ActionListener {
	...
	oldJEXDistributionRightPanel(JEXDistributionPanelController parentController)
	{
